/*  =========================================================================
    czguide_selftest.c - run selftests
...
#ifdef CZGUIDE_BUILD_DRAFT_API
    { "private_classes", czguide_private_selftest },
#endif // CZGUIDE_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running czguide selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-h")) {
            puts ("czguide_selftest.c [options] ...");
